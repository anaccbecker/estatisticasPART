...
df_secao <- .FiltraSecao(df, 319050, 8977000, 319050, 8977800, delta = 50)
...
df_secao <- .FiltraSecao(df, 319300, 8975150, 319780, 8974800, delta = 150)
...
df_secao <- .FiltraSecao(df, 318750, 8975500, 319200, 8975160, delta = 100)
...
plot1 <- 
    ...
    coord_fixed()+
    #theme(legend.position = "none")+
    scale_x_continuous(limits = c(318000,320000), expand = c(0,0))+
    scale_y_continuous(limits = c(8974500,8976000), expand = c(0,0))
plot1

# Vertedor de troncos -------------------------------------------------------------------------


df_secao <- .FiltraSecao(df, 318850, 8975850,318850, 8976200 , delta = 125)
